...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        DeclareLaunchArgument('Grid/FootprintHeight', default_value='"0.0"', description=''),
        ...
        DeclareLaunchArgument('GridGlobal/MinSize', default_value="'6'", description=''),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/livox/lidar', description=''),
